...
arrWrong["dvUser"] = "<img style='margin:2px;' src='"+imgpath+"images/zhuce2.gif'/>&nbsp;用户名未输入或填写错误。";
arrWrong["dvCode"] = "<img style='margin:3px;' src='"+imgpath+"images/zhuce2.gif'/>&nbsp;验证码未输入或填写错误！";
arrWrong["dvPwd"] = "<img style='margin:3px;' src='"+imgpath+"images/zhuce2.gif'/>&nbsp;密码未输入或填写错误！";
