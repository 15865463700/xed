...
class OauthAction extends MCommonAction {
	...
	public function qq(){
		...
		if($loginconfig['qq']['enable']==0) $this->error("此登录方式已被暂时关闭，请选择其他方式登录",__APP__."/");
	...
	private function applogin($uid){//模拟登录
